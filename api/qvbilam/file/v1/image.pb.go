...
var file_image_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x31, 0x0a, 0x13, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x49, 0x6d, 0x61, 0x67, 0x65,
	...
	0x69, 0x73, 0x74, 0x73, 0x32, 0x96, 0x03, 0x0a, 0x05, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x41,
...
var file_image_proto_depIdxs = []int32{
	...
	2, // 2: filePb.v1.Image.Create:input_type -> filePb.v1.UpdateImageRequest
	2, // 3: filePb.v1.Image.Update:input_type -> filePb.v1.UpdateImageRequest
	2, // 4: filePb.v1.Image.Delete:input_type -> filePb.v1.UpdateImageRequest
	4, // 5: filePb.v1.Image.Get:input_type -> filePb.v1.SearchImageRequest
	3, // 6: filePb.v1.Image.GetDetail:input_type -> filePb.v1.GetImageRequest
	3, // 7: filePb.v1.Image.Exists:input_type -> filePb.v1.GetImageRequest
	0, // 8: filePb.v1.Image.Create:output_type -> filePb.v1.ImageResponse
	7, // 9: filePb.v1.Image.Update:output_type -> google.protobuf.Empty
	7, // 10: filePb.v1.Image.Delete:output_type -> google.protobuf.Empty
	1, // 11: filePb.v1.Image.Get:output_type -> filePb.v1.ImagesResponse
	0, // 12: filePb.v1.Image.GetDetail:output_type -> filePb.v1.ImageResponse
	5, // 13: filePb.v1.Image.Exists:output_type -> filePb.v1.ExistsImageResponse
